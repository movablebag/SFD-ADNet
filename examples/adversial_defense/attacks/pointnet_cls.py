...
class get_model(nn.Module):
    def __init__(self, num_class, normal_channel=True, feature_transform=False):
    ...
    def forward(self, pred, target, trans_feat):
        ...
        if trans_feat is not None:
            ...
            if trans_feat.is_cuda:
                I = I.cuda()
            loss += self.mat_diff_loss_scale * torch.mean(torch.norm(torch.bmm(trans_feat, trans_feat.transpose(2,1)) - I, dim=(1,2)))
        return loss
