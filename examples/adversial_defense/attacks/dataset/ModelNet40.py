...
# Import utility functions from the correct paths
from util.augmentation import rotate_point_cloud, jitter_point_cloud
from util.pointnet_utils_gpt4 import normalize_points_np, random_sample_points_np
...
class ModelNet40Hybrid(ModelNet40):
    ...
    Conduct hybrid training between the original data (ori_data) and the defense data (def_data).
    """
